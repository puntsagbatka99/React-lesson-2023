...
export default function NavigationBar(): JSX.Element {
    return (
        <div >
            <div style={{ backgroundColor: "red", display: "flex", justifyContent: "space-between", width: '1100px', height: "104px" }}>
                ...
                <div style={{ display: 'flex', justifyContent: "center", alignItems: 'center' }}>
                    <input type="text" placeholder="Search movies,TV,actors,more..." style={{padding: '1 42px', width: "385px", height: '35px', borderRadius: '26px', border: '1px solid white', backgroundColor: 'rgba(0,0,0,0.4)' }} />
                </div>
                <div style={{ width: "474px", height: "83px", display: 'flex', flexDirection: 'column', justifyContent: 'space-around' }}>
                    ...
                    <div style={{ display: "flex", justifyContent: 'space-between' }}>
                        ...
                        <a href="#" style={{ color: 'white' }}>TV SHOWS</a>
                        <a href="#" style={{ color: 'white' }}>MOVIE TRIVIA</a>
                        <a href="#" style={{ color: 'white' }}>NEWS</a>
                        <a href="#" style={{ color: 'white' }}>SHOWTIMES</a>
                    </div>
                </div>
            </div>
            <div style={{ backgroundColor: 'rgba(0,0,0,.6)', height: '26px', display: 'flex', alignItems: "center", justifyContent: 'space-between', padding: '0 10px' }}>
                <div style={{ display: 'flex' }}>
                    <h4 style={{ color: '#ffe400', marginRight: '10px' }}>TRENDING ON RT</h4>
